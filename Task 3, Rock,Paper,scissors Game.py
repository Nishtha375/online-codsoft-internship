...
class RPSGame:
    ...
    def build_ui(self):
        ...
        btn_frame = tk.Frame(self.root, bg="skyblue")
        ...
        self.result_text = tk.Label(self.root, text="", font=('Times New Roman', 18, 'bold'), bg="white", fg="black")
        ...
        self.reset_btn = tk.Button(self.root, text="🔁 Reset Game", font=('Times New Roman', 12, 'bold'),
                                   bg="white", fg="red", command=self.reset_game)
